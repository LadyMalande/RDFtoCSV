...
class PrefinishedOutputTest {
    ...
    void testConstructorWithFactory() {
        ...
        PrefinishedOutput<String> output = new PrefinishedOutput<>(mockFactory);
    ...
    //BaseRock generated method id: ${testNullFactory}, hash: B1AF20580298FB3466D66B2AD7D8247B
    @Test
    void testNullFactory() {
        assertThrows(NullPointerException.class, () -> new PrefinishedOutput<>((IFactory<String>) null));
    }
