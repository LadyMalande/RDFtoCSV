...
public class StandardModeCSVWIris {
    public static String CSVW_TableGroup = RecognizedPrefixes.predefinedPrefixes.get("csvw") + "TableGroup";
    public static String CSVW_Table = RecognizedPrefixes.predefinedPrefixes.get("csvw") + "Table";
    public static String CSVW_table = RecognizedPrefixes.predefinedPrefixes.get("csvw") + "table";
